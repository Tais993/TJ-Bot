...
public final class SlashCommandInteractionEventBuilder {
     ...
     *         as specified by its {@link SlashCommand#getData()}
     */
    public @NotNull SlashCommandInteractionEventBuilder setOption(@NotNull String name, @NotNull User value) {
     ...
     */
    @NotNull
    public SlashCommandInteractionEventBuilder setUserWhoTriggered(@NotNull Member userWhoTriggered) {
