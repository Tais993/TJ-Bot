...
public final class JdaTester {
    ...
    public JdaTester() {
        ...
        when(replyAction.addActionRow(ArgumentMatchers.<ItemComponent>any())).thenReturn(replyAction);
     ...
     * instance.
     * <p>
     * For example the events created by {@link #createSlashCommandInteractionEvent(SlashCommand)} will return
